---
title: "Linux Kernel의 RX 과정과 그 병목지점"
date: 2025-11-04T15:19:00Z
tags:
  - network
  - linux
summary: "Linux kernel의 트래픽 리시브 과정과 그 병목지점을 알아봅니다."
description: "Linux kernel의 트래픽 리시브 과정과 그 병목지점을 알아봅니다."
---
...
네트워크 옵션 튜닝은 지연시간(Latency)과 대역폭(Throughput) 간의 트레이드오프 관계에 있습니다. 이러한 배경이 앞서 설명한 워크플로우의 기반이 됩니다. 예를 들어 L2 Ethernet 계층의 코드를 살펴보면, NIC에서 skb 인스턴스를 가져오는 과정에서 필연적으로 IRQ 인터럽트가 발생합니다. NAPI poll 과정이 지속되면 CPU 사용률이 급격히 증가하기 때문입니다. 따라서 이 단계에서는 Latency와 Throughput을 각각 최적화하기 위한 파라미터를 개별적으로 조정합니다.
